<div id="progress-bar-button" class="text-left">
    <div class="d-lg-flex justify-content-lg-center align-items-lg-center row text-center">
        <div class="col-12 col-lg-8 mx-auto mb-4 text-center">
            <div class="multisteps-form__progress text-center">
                <a
