    ...
    <div id="content">
        ...
        <div class="container-fluid bg-light">
            ...
            <section>
                <div class="">
                    <form
                        action="{{ route('cv.employment_role.create', [$cv['uuid'], $employment['id']]) }}"
                        method="post"
                                        ...
                                        <div class="m-2 d-flex justify-content-between p-2 bg-warning text-dark">
                                            <div class=" ">
                                                <span class="font-bold">
                                                    {{ Str::limit($role->employment_roles_id ? $role->position->name : $role->other_employment_role, 30) }} 
                                                </span>
                                                <br>
                                                <small>
                                            ...
                                            <div class="data__action mx-3">
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <span class="cursor-pointer mx-2">
                                                        <a
                                                            href="{{ route('cv.employment_role.delete', [$cv['uuid'], $role['id']]) }}"
                                                            data-toggle="tooltip"
                                                            title="Delete Data"
                                                            class="text-danger"
                                                        >
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.edit-role-data').click(function(e) {
                ...
                const form_action = '/cv/'+cv.uuid+'/employment-role/'+employment + '/' + data.id
