        ...
        <div class="div-center">
            ...
            <div class="content">
                ...
                <div class="text-center">
                    <h5 class="head-text">Sign Up to <span class="fs-">Logo<span
                                class="text-yellow">Name</span></span></h3>
                ...
                <form class="mt-4">
                    <div class="mb-3">
                        <input placeholder="Mail" class="form-control  input-round" autocomplete="off"
                            id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <input type="password" placeholder="Password" class="form-control input-round"
                            id="exampleInputPassword1">
                    </div>
                    <div class="mb-3">
                        <input type="password" placeholder="Confirm Password" class="form-control input-round"
                            id="exampleInputPassword1">
                    </div>
