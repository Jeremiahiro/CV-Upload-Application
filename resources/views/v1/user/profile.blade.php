                    ...
                    <div style="text-align: left;">
                        <div class="row">
                            ...
                            <div class="col d-lg-flex justify-content-lg-start align-items-lg-center">
                                ...
                                <!-- <br><br>
                                <a href="#" style="color: var(--bs-yellow);"></a><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-pencil-fill fs-4">
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                <input type="password" placeholder="Current Password" style="padding: 5px !important;" class="form-control" id="exampleInputPassword1">
                              </div>
                              <div class="mb-3">
                                <input type="password" placeholder="New Password" style="padding: 5px !important;" class="form-control" id="exampleInputPassword1">
                              </div>
                              <div class="mb-3">
                                <input type="password" placeholder="Confirm Password" style="padding: 5px !important;" class="form-control" id="exampleInputPassword1">
                              </div>
