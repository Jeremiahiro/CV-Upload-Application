                        ...
                        <div id="multistep-start-column" class="col-12 col-lg-8 m-auto">
                            <form id="main-form" class="multisteps-form__form">
                                <div id="single-form-next" class="multisteps-form__panel shadow p-4 rounded bg-white js-active" data-animation="scaleIn">
                                    ...
                                    <small style="margin-bottom: 15px;color: var(--bs-yellow);font-weight: bold;">Please provide the following information</small>
                                    <div id="form-content" class="multisteps-form__content">
                                        <div id="input-grp-double" class="form-row mt-4">
                                            <div>
                                                <label class="form-label">First Name</label>
                                                <input class="form-control" type="text" placeholder="First Name" style="margin-bottom: 15px;">
                                            </div>
                                ...
                                <div id="single-form-next-prev" class="multisteps-form__panel shadow p-4 rounded bg-white"
                                    ...
                                    <div id="form-content" class="multisteps-form__content">
                                        <div id="input-grp-double" class="form-row mt-4">
                                            ...
                                            <div id="form-content" class="multisteps-form__content">
                                                ...
                                                <div><label class="form-label">Street</label><input
                                                ...
                                                <div><label class="form-label">Home Phone Number</label><input
                                                    class="form-control" type="text" placeholder=""
                                                    style="margin-bottom: 15px;"></div>
                                                <div><label class="form-label">Email</label><input
                                ...
                                <div id="single-form-next-prev-2" class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                                    ...
                                    <small style="margin-bottom: 15px;color: var(--bs-yellow);font-weight: bold;">Please provide the following
                                        information</small>
                                    <div id="form-content-3" class="multisteps-form__content">
                                        <div id="input-grp-double-3" class="form-row mt-4">
                                            ...
                                            <div>
                                                <label class="form-label">Qualification Obtained</label><select class="form-select"
                                                    style="margin-bottom: 15px;">
                                    ...
                                    <div id="single-form-next-prev-3"
                                        ...
                                        <p style="margin-bottom: 0;color: black;font-weight: bold;">Professional Qualification
                                            </p>
                                            <small
                                                style="margin-bottom: 15px;color: var(--bs-yellow);font-weight: bold;">Please
                                            provide the following information</small>
                                        <div id="form-content-4" class="multisteps-form__content">
                                            <div id="input-grp-double-4" class="form-row mt-4">
                                                <div>
                                                    <label class="form-label">Name of profession</label><input class="form-control" type="text"
                                                        placeholder="" style="margin-bottom: 15px;">
                                                </div>

                                                <div>
                                                    <label class="form-label">Type of qualification</label>
                                                    <input class="form-control" type="text" placeholder="Student master" style="margin-bottom: 15px;">
                                                </div>
                                                <div>
                                                    <label class="form-label">If others, please enter the type of qualification here?</label>
                                                    <input class="form-control" type="text" placeholder="" style="margin-bottom: 15px;">
                                                </div>

                                                <div><label class="form-label">Date qualification obtained Entry date</label><input
                                                    class="form-control" type="date"
                                                    style="margin-bottom: 15px;"></div>
                                                    <div>
                                                    ...
                                                    <div style="margin-bottom: 15px;">
                                                        <label class="form-label">Have you completed your NYSC service or are you currently serving?</label><br>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
                                                            <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                        </div>
                                    ...
                                    <div id="single-form-next-prev-4"
                                        class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                                        <p style="margin-bottom: 0;color: black;font-weight: bold;">Your NYSC service year</p>
                                            <small
                                                style="margin-bottom: 15px;color: var(--bs-yellow);font-weight: bold;">Please
                                            provide the following information</small>
                                        <div id="form-content-5" class="multisteps-form__content">
                                            <div id="input-grp-double-5" class="form-row mt-4">
                                                <div>
                                                    <label class="form-label">What state did you serve for your National service?</label><input class="form-control" type="text"
                                                        placeholder="" style="margin-bottom: 15px;">
                                                </div>
                                                <div><label class="form-label">What month and what year did you commence your National service?</label><input
                                                    class="form-control" type="date"
                                                    style="margin-bottom: 15px;"></div>
                                                    <div style="margin-bottom: 15px;">
                                    ...
                                    <div id="single-form-next-prev-5"
                                        class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                                        <p style="margin-bottom: 0;color: black;font-weight: bold;">Your previous employment history
                                            </p>
                                            <small
                                                style="margin-bottom: 15px;color: var(--bs-yellow);font-weight: bold;">Please
                                            provide the following information</small>
                                        <div id="form-content-6" class="multisteps-form__content">
                                            <div id="input-grp-double-6" class="form-row mt-4">
                                                <div>
                                                    <label class="form-label">Name of previous employer</label><input class="form-control" type="text"
                                                        placeholder="" style="margin-bottom: 15px;">
                                                </div>
                                                ...
                                                <div>
                                                    <label class="form-label">Employment date</label><input class="form-control" type="date"
                                                        placeholder="" style="margin-bottom: 15px;">
                                                </div>
                                                <div>
                                                ...
                                                <div><label class="form-label">What are your
                                                    responsibilities</label><textarea
                                                        class="form-control"></textarea>
                                                </div>
                                                <div>
                                                    <label class="form-label">How many positions did you hold with this employer?</label><input class="form-control" type="text"
                                                        placeholder="" style="margin-bottom: 15px;">
                                                </div>
                                            </div>
                                    ...
                                    <div id="single-form-next-prev-6"
                                        class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                                        <p style="margin-bottom: 0;color: black;font-weight: bold;">Your Current Employment Details
                                            </p>
                                            <small
                                                style="margin-bottom: 15px;color: var(--bs-yellow);font-weight: bold;">Please
                                    ...
                                    <div id="single-form-next-prev-7"
                                        ...
                                        <p style="margin-bottom: 0;color: black;font-weight: bold;">Employment Roles
                                            ...
                                            <small
                                                style="margin-bottom: 15px;color: var(--bs-yellow);font-weight: bold;">Position /role description</small>
                                        <div id="form-content-8" class="multisteps-form__content">
                                            <div id="input-grp-double-8" class="form-row mt-4">
                                                ...
                                                <div>
                                                    <label class="form-label">What date did you stop working with this employer?</label><input class="form-control" type="date"
                                                        placeholder="" style="margin-bottom: 15px;">
                                                </div>
                                                <div style="margin-bottom: 15px;">
                                    ...
                                    <div id="single-form-next-prev-8"
                                        ...
                                        <div id="form-content-9" class="multisteps-form__content">
                                            <div id="input-grp-double-9" class="form-row mt-4">
                                                <div>
                                                    <label class="form-label">Name of referee</label><input class="form-control" type="text"
                                                        placeholder="" style="margin-bottom: 15px;">
                                                </div>
                                    ...
                                    <div id="single-form-next-prev-9"
                                        class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                                        <p style="margin-bottom: 0;color: black;font-weight: bold;">Your location and industry employment preferences
                                            </p>
                                            <small
                                                style="margin-bottom: 15px;color: var(--bs-yellow);font-weight: bold;">Please
                                            provide the following information</small>
                                        <div id="form-content-10" class="multisteps-form__content">
                                            <div id="input-grp-double-10" class="form-row mt-4">
                                                ...
                                                <div>
                                                    <label class="form-label">My preferred location for employment is </label><select class="form-select"
                                                        style="margin-bottom: 15px;">
                                                ...
                                                <div>
                                                    <label class="form-label">My preferred industry for employment is </label><select class="form-select"
                                                        style="margin-bottom: 15px;">
                                    ...
                                    <div id="single-form-next-prev-10"
                                        class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                                        <p style="margin-bottom: 0;color: black;font-weight: bold;">Hobbies and other information
                                            </p>
                                            <small
                                                style="margin-bottom: 15px;color: var(--bs-yellow);font-weight: bold;">Please
                                            fill the following information</small>
                                        <div id="form-content-11" class="multisteps-form__content">
                                            <div id="input-grp-double-11" class="form-row mt-4">
                                                <div><label class="form-label">Please list your hobbies in the text box below</label><textarea
                                                    class="form-control"></textarea>
                                            </div>
                                            <div class="mt-3"><label class="form-label">Please enter any additional information you think is important for a potential employer to know</label><textarea
                                                class="form-control"></textarea>
                                        </div>
                                            </div>
